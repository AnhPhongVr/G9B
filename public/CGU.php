...
<!-- Titre de la page CGU -->
<h1><center>Bienvenue sur notre site!</center></h1>
<h1><center> Conditions générales d'utilisation </center></h1>
		
  <!-- Accordion bootstrap5 -->
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="headingThree">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
        Article 4: ACCEPTATION DES CONDITIONS D'UTILISATIONS
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="collapseSix">
      <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
        Article 7: SERVICES REESERVES AUX UTILISATEURS INSCRITS
      </button>
    </h2>
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="collapseSeven">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="collapseEight">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="collapseTen">
  ...
  <div class="accordion-item">
    <h2 class="accordion-header" id="collapseEleven">
